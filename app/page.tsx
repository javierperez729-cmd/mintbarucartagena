  ...
  return (
    <main>
        ...
        <div className="absolute inset-0 flex items-center justify-center text-center px-6">
          <div>
            ...
            <p className="mt-4 text-white/90 text-lg md:text-xl">
              A private luxury retreat in Cartagena
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-4xl mx-auto px-6 py-24 text-center">
        <h2 className="text-4xl mb-6">Caribbean Serenity</h2>
        <p className="text-[#6B6B6B] leading-relaxed">
          Nestled along the untouched shores of Barú, Mint Barú offers an
          intimate escape defined by natural beauty, understated luxury, and
      ...
      <section className="py-24 text-center px-6">
        <h2 className="text-4xl mb-12">The Experience</h2>
      ...
      <section className="py-24 text-center bg-white">
        <h2 className="text-4xl mb-6">Opening Soon</h2>
